...
class CognitoAuth(object):
    ...
    def get_token(self):
        ...
        log.debug(f"Token passed in the heander: {auth_header_value}")
    ...
    def decode_token(self, token):
        ...
        try:
            ...
            raise cognitojwt.CognitoJWTException('Malformed Authentication Token')
